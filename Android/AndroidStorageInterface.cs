...
[assembly: Dependency(typeof(TimeTracker.Droid.AndroidStorageInterface))]

namespace TimeTracker.Droid
{
    //this code is taken from https://github.com/lukasaldersley/XamarinTools
    //reduced-feature version of UWPStorageInterface.cs; for documentaion look there (good luck!)
    class AndroidStorageInterface : IStorageInterface
    {
